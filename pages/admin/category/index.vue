                ...
                <div class="col-xxl-12">
                    <div class="breadcrumb__content p-relative z-index-1">
                        <div class="breadcrumb__list">
                            ...
                            ></span>
                            <span> ประเภทงานบริการวิชาการ </span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey">
                ...
                <div class="col-12 col-lg-12 mb-20">
                    <input
                        ...
                        name="title"
                        type="text"
                        placeholder="ชื่อประเภทงานบริการวิชาการ"
                    />
                </div>
        ...
        <div class="container">
            <div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey">
                <h4 class="section-bg-primary mb-20">
                    ...
                    <span class="ml-10">รายการประเภทงานบริการวิชาการ</span>
                </h4>
                ...
                <div class="mb-20">
                    <button
                        ...
                        @click="
                            () => {
                                $router.push({ path: '/admin/category/add' });
                            }
                        "
                    >
