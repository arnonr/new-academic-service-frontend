<template>
    <div class="container py-1">
        <div
            class="card mb-3"
            style="border: 1px solid #eee; border-radius: 1em; padding: 1em"
        >
            <div class="row g-0">
                <!-- รูปภาพ -->
                            ...
                            >
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th class="text-muted">เอกชน</th>
                                        <th class="text-muted">หน่วย</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr
                                        class="text-center"
                                        v-for="(itt, idx) in item.test_types"
                                        :key="idx"
                                    >
                                        <td>
                                            {{ itt.name_th }}
...
export default {
    ...
    setup(props) {
        ...
        const { clientBase } = config.public;
        ...
        const updateTooltip = () => {
            ...
            if (tooltipButton.value) {
                tooltipInstance = tippy(tooltipButton.value, {
                    theme: "light",
                    allowHTML: true,
