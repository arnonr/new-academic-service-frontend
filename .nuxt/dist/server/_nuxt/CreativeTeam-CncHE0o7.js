...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))}><div class="team__thumb-6 w-img fix">`);
  _push(ssrRenderComponent(_component_nuxt_link, { href: "/team-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", $props.team.img)} alt="team img"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: $props.team.img,
  ...
  _push(`</div><div class="team__content-6 transition-3"><div class="team__content-6-bg"></div><h3 class="team__title-6">`);
  _push(ssrRenderComponent(_component_nuxt_link, { href: "/team-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`${ssrInterpolate($props.team.name)}`);
      } else {
        return [
          createTextVNode(toDisplayString($props.team.name), 1)
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</h3><span class="team__designation-6">${ssrInterpolate($props.team.title)}</span></div></div>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/teams/single-team/CreativeSingleTeam.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const CreativeSingleTeam = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main = {
  props: {
    el_style: {
      type: Boolean,
  ...
  mixins: [teamData],
  components: { CreativeSingleTeam }
};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_creative_single_team = resolveComponent("creative-single-team");
  const _component_nuxt_link = __nuxt_component_0;
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "team__area pt-110 pb-125" }, _attrs))}><div class="container">`);
  if ($props.el_style) {
  ...
  if (!$props.el_style) {
    ...
    _push(ssrRenderComponent(_component_nuxt_link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(` View all Team Member <span${_scopeId}><i class="fa-regular fa-arrow-right"${_scopeId}></i></span>`);
        } else {
          return [
            createTextVNode(" View all Team Member "),
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/teams/CreativeTeam.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CreativeTeam = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  CreativeTeam as C
};
//# sourceMappingURL=CreativeTeam-CncHE0o7.js.map
