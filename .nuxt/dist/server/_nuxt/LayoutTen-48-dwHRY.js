import HeaderTen from "./HeaderTen-CJbgqrlG.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_header_ten = resolveComponent("header-ten");
  const _component_back_to_top = resolveComponent("back-to-top");
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(_component_header_ten, null, null, _parent));
  _push(`<main>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/LayoutTen.vue");
...
//# sourceMappingURL=LayoutTen-48-dwHRY.js.map
