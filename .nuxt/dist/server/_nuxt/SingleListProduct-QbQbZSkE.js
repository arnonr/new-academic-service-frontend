...
import { P as ProductModal } from "./productData-D-fZVTZg.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><div class="product__list-item mb-30" data-sal="slide-up" data-sal-delay="130" data-sal-duration="1000"><div class="row"><div class="col-xl-5 col-lg-5"><div class="product__thumb product__list-thumb p-relative fix m-img">`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    href: `/product-details/${$props.item.id}`
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", $props.item.image)} alt="product img"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
  ...
  _push(`</div></div><div class="col-xl-7 col-lg-7"><div class="product__list-content"><div class="product__rating product__rating-2 d-flex"><span><i class="icon_star"></i></span><span><i class="icon_star"></i></span><span><i class="icon_star"></i></span><span><i class="icon_star"></i></span><span><i class="icon_star_alt"></i></span></div><h3 class="product__list-title">`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    href: `/product-details/${$props.item.id}`
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shop/SingleListProduct.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SingleListProduct = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  SingleListProduct as S
};
//# sourceMappingURL=SingleListProduct-QbQbZSkE.js.map
