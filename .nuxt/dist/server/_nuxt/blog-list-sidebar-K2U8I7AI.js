...
const _sfc_main$1 = {
  components: { BlogPagination: _sfc_main$2, BlogSidebar, SingleBlogListItem },
  mixins: [blogData]
};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div></div></div><div class="col-lg-4">`);
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/blogs/BlogListArea.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const BlogListArea = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main = {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/blog-list-sidebar.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const blogListSidebar = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  blogListSidebar as default
};
//# sourceMappingURL=blog-list-sidebar-K2U8I7AI.js.map
