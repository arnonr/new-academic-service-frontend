...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "features__area pt-80 pb-20" }, _attrs))}><div class="container"><div class="row"><!--[-->`);
  ssrRenderList($data.feature_data, (item, i) => {
    _push(`<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6"><div class="features__item-13 d-flex align-items-start mb-40"><div class="features__icon-13"><span>${item.icon ?? ""}</span></div><div class="features__content-13"><h3 class="features__title-13">${ssrInterpolate(item.title)}</h3><p>${item.subtitle ?? ""}</p></div></div></div>`);
  });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shop/ShopFeatures.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ShopFeatures = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  ShopFeatures as S
};
//# sourceMappingURL=ShopFeatures-CN3dWQQq.js.map
