import { u as useHead, n as _sfc_main$1, g as useRuntimeConfig, d as useCookie, a as __nuxt_component_0 } from "../server.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><section class="breadcrumb__area include-bg pb-40 pt-30 grey-bg-4"><div class="container"><div class="row"><div class="col-xxl-12"><div class="breadcrumb__content p-relative z-index-1"><div class="breadcrumb__list"><span> จัดการข้อมูล </span><span class="dvdr"><i class="fa-solid fa-circle-small"></i></span><span> งานบริการวิชาการ </span></div></div></div></div></div></section><section class="portfolio__area pt-40"><div class="container"><div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey"><h4 class="section-bg-primary mb-20"><i class="fa-solid fa-search"></i><span class="ml-10">ค้นหา</span></h4><div class="col-12 col-lg-12 mb-20"><input class="form-control"${ssrRenderAttr("value", unref(search).title_th)} name="title" type="text" placeholder="ชื่อหัวข้องานบริการวิชาการ"></div><div><button class="btn btn-success">ค้นหา</button></div></div></div></section><section class="portfolio__area pb-20"><div class="container"><div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey"><h4 class="section-bg-primary mb-20"><i class="fa-regular fa-list"></i><span class="ml-10">รายการงานบริการวิชาการ</span></h4><div class="mb-20"><button type="button" class="btn btn-primary"><i class="fa-regular fa-plus"></i> เพิ่มข้อมูล </button></div><div class="row gx-2 grid"><div class="col-12"><div class="table-responsive"><table class="table table-bordered table-striped table-admin"><thead><tr><th class="text-center">ชื่อ (TH)</th><th class="text-center">หน่วยงาน</th><th class="text-center">ประเภท</th><th class="text-center">สถานะ</th><th class="text-center">จัดการ</th></tr></thead>`);
      if (unref(items).length != 0) {
        _push(`<tbody><!--[-->`);
        ssrRenderList(unref(items), (it, idx) => {
          _push(`<tr><td cla ss="text-center">${ssrInterpolate(it.title_th)}</td><td class="text-center">${ssrInterpolate(it.department.name_th)}</td><td class="text-center">${ssrInterpolate(it.service_category.name_th)}</td><td class="text-center">`);
          ...
          _push(`<button class="btn btn-danger ml-5"><i class="fa-regular fa-trash"></i></button></td></tr>`);
        });
        _push(`<!--]--></tbody>`);
      } else {
        _push(`<!---->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/serve/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=index-Cy4rtUg4.js.map
