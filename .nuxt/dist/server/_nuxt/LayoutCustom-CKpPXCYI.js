...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/LayoutCustom.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const LayoutCustom = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  LayoutCustom as default
};
//# sourceMappingURL=LayoutCustom-CKpPXCYI.js.map
